...
<link rel="stylesheet" href="./css/RegiFormValidate.css"/>
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
<script src="./js/RegiFormValidate.js"></script>
</head>
<body>
    <form name="myform" action="/registProcess.do" method="post">
        <table class="userTable">
            ...
            <tr>
                ...
                <td class="userVal">
                    <input type="text" name="id" value="kosmo1234" maxlength="15" class="userInput"
                        style="width:120px;" />                    
            ...
            <tr>
                ...
                <td class="userVal">
                    <input type="password" name="pass1" value="1234" style="width:100px;" class="userInput"
                        maxlength="25" />
                </td>
            </tr>
            <tr>
                ...
                <td class="userVal">
                    <input type="password" name="pass2" value="1234" style="width:100px;" class="userInput"
                        maxlength="25" />
            ...
            <tr>
                ...
                <td class="userVal">
                    <input type="text" name="name" value="홍길동" style="width:120px;" class="userInput" maxlength="10" />
                </td>
            </tr>
            <tr>
                ...
                <td class="userVal">
                    ...
                    <input type="text" name="birth1" value="2000" class="userInput w40" maxlength="4" /><span style="margin:0 5px 0 1px;">년</span>
                    <input type="text" name="birth2" value="01" class="userInput w20" maxlength="2" /><span style="margin:0 5px 0 1px;">월</span>
                    <input type="text" name="birth3" value="01" class="userInput w20"maxlength="2" /><span style="margin:0 15px 0 1px;">일</span>
            ...
            <tr>
                ...
                <td class="userVal">
                    <input type="text" name="email1" value="test" class="userInput w100" />
                    <span style="font-size:16px;">＠</span>
                    <input type="text" name="email2" value="gmail.com" class="userInput w100" />
            ...
            <tr>
                ...
                <td class="userVal">
                    ...
                    <input type="text" name="zipcode" maxlength="10" value="00000" class="userInput w50" /> (우편번호)
                </td>
            </tr>
            <tr>
                <td class="userVal">
                    <input type="text" name="addr1" class="userInput w510" maxlength="100" value="서울 강동구" />
                </td>
            </tr>
            <tr>
                <td class="userVal">
                    <input type="text" name="addr2" class="userInput w410" maxlength="100" value="301호" />
                    <span style="margin-left:10px;"></span>
                    + 나머지 주소
                </td>
            </tr>
            <tr>
                ...
                <td class="userVal">
                    <input type="text" name="phone1" value="010" class="userInput w30" maxlength="3" onkeyup="focusMove(this,'phone2',3);" /> -
                    <input type="text" name="phone2" value="1234" class="userInput w40" maxlength="4" onkeyup="focusMove(this,'phone3',4);" /> -
                    <input type="text" name="phone3" value="1234" class="userInput w40" maxlength="4" onkeyup="focusMove(this,'mobile1',4);" />
                </td>
            </tr>
            <tr>
                <td class="userTit"><span class="c_imp">*</span> 휴대전화</td>
                <td class="userVal">
                    <input type="text" name="mobile1" value="010" class="userInput w30" onkeyup="focusMove(this,'mobile2',3);"/> -
                    <input type="text" name="mobile2" value="1234" class="userInput w40" maxlength="4" onkeyup="focusMove(this,'mobile3',4);"/> -
                    <input type="text" name="mobile3" value="1234" class="userInput w40" maxlength="4" onkeyup="focusMove(this,'etc_no1',4);"/>
                    <span style="margin-left:20px;"></span>
            ...
            <tr>
                ...
                <td class="userVal" style="padding:3px 0 3px 10px;">
                    <select name="etc_no1" class="userSelect w300">
                        ...
                        <option value="1" selected>책을 출판하기 위해서</option>
            ...
            <tr>
                ...
                <td class="userVal" style="padding:3px 0 3px 10px;">
                    <select name="etc_no2" class="userSelect w300">
                        ...
                        <option value="91" selected>네이버 검색</option>
